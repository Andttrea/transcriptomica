...
En la figura 1 se observó que las réplicas están muy próximas dentro de cada edad y hay una separación clara entre `mm_9` y `mm_24`, lo que indicó baja variabilidad técnica y una señal biológica fuerte. De igual manera, en la figura 2 se mostró un patrón prácticamente superponible al de HISAT2. Las muestras de cada condición forman nubes compactas y bien separadas. Por su parte, la figura 3 mostró que la separación por edad persistió, pero las réplicas exhiben mayor dispersión que en los alineadores genómicos, lo que sugirió mayor variabilidad atribuible al pseudoalineamiento o a la cuantificación a nivel de transcritos.


##### Por método estadístico: DESeq2 vs edgeR

::: {layout-ncol=2}
![PCA para STAR (single-end, DESeq2)](https://raw.githubusercontent.com/Andttrea/transcriptomica/refs/heads/main/deseq/results/star/single_end/deseq_results/figuras/PCA_plot.png)

![PCA para STAR (single-end, edgeR)](https://raw.githubusercontent.com/Andttrea/transcriptomica/refs/heads/main/deseq/results/star/single_end/edgeR_results/figuras/PCA_plot.png)
:::
...
::: {layout-ncol=2}
![PCA para Salmon (single-end, edgeR)](https://raw.githubusercontent.com/Andttrea/transcriptomica/refs/heads/main/deseq/results/salmon/single_end/edgeR_results/figuras/PCA_plot.png)

![PCA para Salmon (paired-end, edgeR) ](https://raw.githubusercontent.com/Andttrea/transcriptomica/refs/heads/main/deseq/results/salmon/paired_end/edgeR_results/figuras/PCA_plot.png) 
:::
...
::: {layout-ncol=3}
![Volcano plot para STAR (paired-end, DESeq2)](https://raw.githubusercontent.com/Andttrea/transcriptomica/refs/heads/main/deseq/results/star/paired_end/deseq_results/figuras/volcano_plot.png)

![Volcano plot para HISAT2 (paired-end, DESeq2)](https://raw.githubusercontent.com/Andttrea/transcriptomica/refs/heads/main/deseq/results/hisat2/paired_end/deseq_results/figuras/volcano_plot.png)

![Volcano plot para Salmon (paired-end, DESeq2)](https://raw.githubusercontent.com/Andttrea/transcriptomica/refs/heads/main/deseq/results/salmon/paired_end/deseq_results/figuras/volcano_plot.png)
:::
...
![Volcano plot para STAR (paired-end, edgeR)](https://raw.githubusercontent.com/Andttrea/transcriptomica/refs/heads/main/deseq/results/star/paired_end/edgeR_results/figuras/volcano_plot.png)
:::
...
::: {layout-ncol=2}
![Volcano plot para HISAT2 (paired-end, edgeR)](https://raw.githubusercontent.com/Andttrea/transcriptomica/refs/heads/main/deseq/results/hisat2/paired_end/edgeR_results/figuras/volcano_plot.png)

![Volcano plot para HISAT2 (single-end, edgeR)](https://raw.githubusercontent.com/Andttrea/transcriptomica/refs/heads/main/deseq/results/hisat2/single_end/edgeR_results/figuras/volcano_plot.png)
:::
...
Además, algunos de estos genes apuntan a procesos biológicamente muy plausibles en músculo esquelético envejecido. Por ejemplo, la recurrencia de Dbp sugiere alteraciones del componente circadiano del músculo, relevante para la regulación temporal del metabolismo, la regeneración y el mantenimiento de la masa muscular, procesos cuya desorganización se ha vinculado con envejecimiento. De manera similar, la detección consistente de Serpinh1 podría reflejar cambios en maduración de colágeno y remodelado de matriz extracelular, dado que HSP47/SERPINH1 actúa como chaperona específica de colágeno y su aumento suele asociarse con reorganización estromal y respuestas fibróticas. Asimismo, la presencia repetida de Ppp1r3c es compatible con modificaciones en el manejo del glucógeno y la flexibilidad metabólica del tejido muscular, dimensiones que también tienden a deteriorarse con la edad. 
...
4. Valle-García, D. (2026). Clase 8: Expresión diferencial [Notas de clase en formato HTML]. EPI AGING LAB, Cinvestav 
5. Ito, S., & Nagata, K. (2017). Biology of Hsp47 (Serpin H1), a collagen-specific molecular chaperone. Seminars in cell & developmental biology, 62, 142–151. https://doi.org/10.1016/j.semcdb.2016.11.005 
6. Chatterjee, S., & Ma, K. (2016). Circadian clock regulation of skeletal muscle growth and repair. F1000Research, 5, 1549. https://doi.org/10.12688/f1000research.9076.1 
7. Montori-Grau, M., Guitart, M., García-Martínez, C., Orozco, A., & Gómez-Foix, A. M. (2011). Differential pattern of glycogen accumulation after protein phosphatase 1 glycogen-targeting subunit PPP1R6 overexpression, compared to PPP1R3C and PPP1R3A, in skeletal muscle cells. BMC biochemistry, 12, 57. https://doi.org/10.1186/1471-2091-12-57 
